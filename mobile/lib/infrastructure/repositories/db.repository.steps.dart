...
final class Schema27 extends i0.VersionedSchema {
  ...
  late final List<i1.DatabaseSchemaEntity> entities = [
    ...
    idxTrashedLocalAssetAlbum,
    idxAssetEditAssetId,
    idxOfflineAssetRemoteAssetId,
    idxOfflineAssetLastAccessed,
  ];
  late final Shape33 userEntity = Shape33(
    source: i0.VersionedTable(
      entityName: 'user_entity',
  ...
  late final Shape37 localAlbumEntity = Shape37(
    source: i0.VersionedTable(
      entityName: 'local_album_entity',
      withoutRowId: true,
      isStrict: true,
  ...
  late final Shape38 localAlbumAssetEntity = Shape38(
    source: i0.VersionedTable(
      entityName: 'local_album_asset_entity',
      withoutRowId: true,
      isStrict: true,
      tableConstraints: [
        ...
        'FOREIGN KEY(album_id)REFERENCES local_album_entity(id)ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED',
        'FOREIGN KEY(asset_id)REFERENCES local_asset_entity(id)ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED',
      ],
      columns: [_column_156, _column_159],
      attachedDatabase: database,
    ),
    alias: null,
  );
  ...
  late final Shape39 authUserEntity = Shape39(
    source: i0.VersionedTable(
      entityName: 'auth_user_entity',
      withoutRowId: true,
      isStrict: true,
  ...
  late final Shape40 userMetadataEntity = Shape40(
    source: i0.VersionedTable(
      entityName: 'user_metadata_entity',
      withoutRowId: true,
      isStrict: true,
      tableConstraints: [
        'PRIMARY KEY(user_id)',
        'FOREIGN KEY(user_id)REFERENCES user_entity(id)ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED',
      ],
      columns: [_column_107, _column_205],
      attachedDatabase: database,
    ),
    alias: null,
  );
  late final Shape41 partnerEntity = Shape41(
    source: i0.VersionedTable(
      ...
      tableConstraints: [
        ...
        'FOREIGN KEY(user_id)REFERENCES user_entity(id)ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED',
        'FOREIGN KEY(shared_with_id)REFERENCES user_entity(id)ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED',
      ],
      columns: [_column_107, _column_131, _column_120],
      attachedDatabase: database,
    ),
    alias: null,
  );
  late final Shape42 remoteExifEntity = Shape42(
    source: i0.VersionedTable(
      ...
      tableConstraints: [
        ...
        'FOREIGN KEY(asset_id)REFERENCES remote_asset_entity(id)ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED',
      ],
      columns: [
        _column_159,
        _column_108,
  ...
  late final Shape43 remoteAlbumAssetEntity = Shape43(
    source: i0.VersionedTable(
      entityName: 'remote_album_asset_entity',
      withoutRowId: true,
      isStrict: true,
      tableConstraints: [
        'PRIMARY KEY(album_id, asset_id)',
        'FOREIGN KEY(album_id)REFERENCES remote_album_entity(id)ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED',
        'FOREIGN KEY(asset_id)REFERENCES remote_asset_entity(id)ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED',
      ],
      columns: [_column_156, _column_159],
      attachedDatabase: database,
  ...
  late final Shape44 remoteAlbumUserEntity = Shape44(
    source: i0.VersionedTable(
      entityName: 'remote_album_user_entity',
      withoutRowId: true,
      isStrict: true,
      ...
      columns: [_column_156, _column_107, _column_157],
      attachedDatabase: database,
    ),
    alias: null,
  );
  late final Shape45 remoteAssetCloudIdEntity = Shape45(
    source: i0.VersionedTable(
      entityName: 'remote_asset_cloud_id_entity',
      withoutRowId: true,
      isStrict: true,
      ...
      columns: [_column_159, _column_158],
      attachedDatabase: database,
    ),
    alias: null,
  );
  late final Shape46 memoryEntity = Shape46(
    source: i0.VersionedTable(
      entityName: 'memory_entity',
      withoutRowId: true,
      isStrict: true,
  ...
  late final Shape47 memoryAssetEntity = Shape47(
    source: i0.VersionedTable(
      entityName: 'memory_asset_entity',
      withoutRowId: true,
      isStrict: true,
      tableConstraints: [
        ...
        'FOREIGN KEY(memory_id)REFERENCES memory_entity(id)ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED',
        'FOREIGN KEY(asset_id)REFERENCES remote_asset_entity(id)ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED',
      ],
      columns: [_column_156, _column_159],
      attachedDatabase: database,
  ...
  late final Shape35 personEntity = Shape35(
    source: i0.VersionedTable(
      entityName: 'person_entity',
      withoutRowId: true,
      isStrict: true,
  ...
  late final Shape31 assetFaceEntity = Shape31(
    source: i0.VersionedTable(
      entityName: 'asset_face_entity',
      withoutRowId: true,
      isStrict: true,
      tableConstraints: [
        'PRIMARY KEY(id)',
        'FOREIGN KEY(asset_id)REFERENCES remote_asset_entity(id)ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED',
        'FOREIGN KEY(person_id)REFERENCES person_entity(id)ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED',
      ],
      columns: [
        _column_107,
        _column_159,
  ...
  late final Shape34 storeEntity = Shape34(
    source: i0.VersionedTable(
      entityName: 'store_entity',
      withoutRowId: true,
      isStrict: true,
      tableConstraints: ['PRIMARY KEY("key")'],
      columns: [_column_210, _column_211],
      attachedDatabase: database,
    ),
    alias: null,
  );
  ...
  late final Shape51 offlineAssetEntity = Shape51(
    source: i0.VersionedTable(
      ...
      tableConstraints: [
        ...
        'FOREIGN KEY(remote_asset_id)REFERENCES remote_asset_entity(id)ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED',
      ],
      columns: [
        _column_213,
        _column_214,
  ...
  final i1.Index idxOfflineAssetRemoteAssetId = i1.Index(
  ...
  final i1.Index idxOfflineAssetLastAccessed = i1.Index(
...
class Shape51 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get thumbnailPath =>
      columnsByName['thumbnail_path']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get fullImagePath =>
      columnsByName['full_image_path']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get videoPath =>
      columnsByName['video_path']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get downloadedAt =>
      columnsByName['downloaded_at']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get fileSize =>
      columnsByName['file_size']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get lastAccessedAt =>
      columnsByName['last_accessed_at']! as i1.GeneratedColumn<String>;
}
